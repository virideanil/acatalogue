...
export class QuadTree {
  ...
  children: Int32Array = new Int32Array(0);
  head: Int32Array = new Int32Array(0);
  depth: Uint8Array = new Uint8Array(0);
  ...
  half: Float64Array = new Float64Array(0);
  q: Float64Array = new Float64Array(0);
  qx: Float64Array = new Float64Array(0);
  qy: Float64Array = new Float64Array(0);
  bx0: Float64Array = new Float64Array(0);
  bx1: Float64Array = new Float64Array(0);
  by0: Float64Array = new Float64Array(0);
  by1: Float64Array = new Float64Array(0);
  ...
  near: Int32Array = new Int32Array(0);
  far: Int32Array = new Int32Array(0);
  ...
  private grow(min: number): void {
    ...
    const i32 = (a: Int32Array, len: number): Int32Array => {
      const b = new Int32Array(len);
      b.set(a.subarray(0, Math.min(a.length, len)));
      return b;
    };
    const f64 = (a: Float64Array): Float64Array => {
  ...
  private alloc(cx: number, cy: number, half: number, depth: number): number {
  ...
  private child(node: number, quad: number): number {
  ...
  build(x: Float64Array, y: Float64Array, charge: Float64Array, n: number): void {
    this.count = 0;
    this.n = n;
    ...
    if (this.capacity < 2 * n + 8) this.grow(2 * n + 8);
    let minX = Infinity;
    let minY = Infinity;
    let maxX = -Infinity;
    let maxY = -Infinity;
