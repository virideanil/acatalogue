...
export class Camera {
    ...
    setLimits(fitScale, x0, y0, x1, y1) {
    ...
    setTarget(x, y, scale = this.targetScale) {
        this.tx = x;
        this.ty = y;
    ...
    advance(frameSeconds) {
        ...
        if (steps >= CAMERA.maxStepsPerFrame)
            this.accumulator = 0;
